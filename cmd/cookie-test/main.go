...
func main() {
	...
	mux.Handle("/add", NoopHandler(NoopHandler(AddHandler(RedirectHandler()))))
	mux.Handle("/remove", NoopHandler(NoopHandler(RemoveFirstHandler(RemoveSecondHandler(RedirectHandler())))))
